set.seed(1313)
covid_spring <- read.table("https://raw.githubusercontent.com/g-rho/DaSci_SoSe23/master/Daten/covid_spring.csv", sep =";", header = TRUE, stringsAsFactors = TRUE)
covid_summer <- read.table("https://raw.githubusercontent.com/g-rho/DaSci_SoSe23/master/Daten/covid_summer.csv", sep =";", header = TRUE, stringsAsFactors = TRUE)
